...
public class main {
	...
	public static void main(String[] args) {
		...
		Empleado objEmpleado1 = new Empleado("0021", "Manuel", "Ruiz", "Bocanegra", "4562070", 28);
		Empleado objEmpleado2 = new Empleado("0022", "Julio", "Fernandez", "Villa El Salvador", "5723065", 32);
		Empleado objEmpleado3 = new Empleado("0024", "Ana Karina", "Llanos", "Callao", "994880339", 27);
		...
		/*
		ArrayList<Empleado> arrEmpleado;
		arrEmpleados = new ArrayList<Empleado>();

		arrEmpleado.add(objEmpleado1);
		arrEmpleado.add(objEmpleado2);
		...
		ArrayList<String> arregloCadena;
		arregloCadena=new ArrayList<String>();
		
		arregloCadena.add("cadena1");
		arregloCadena.add("cadena2");
		arregloCadena.add("cadena3");
		arregloCadena.add("cadena4");
		...
		System.out.println("valor de ultima posicion = "+arreglo[(arreglo.length-1)]);
		*/
		}
